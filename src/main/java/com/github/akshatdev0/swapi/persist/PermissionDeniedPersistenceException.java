...
public class PermissionDeniedPersistenceException extends NonTransientPersistenceException {

  /**
   * Constructor for PermissionDeniedPersistenceException.
   *
   * @param msg the detail message
   * @param cause the root cause from the underlying persistence API, such as JDBC
   */
  public PermissionDeniedPersistenceException(String msg, Throwable cause) {
    super(msg, cause);
  }
}
