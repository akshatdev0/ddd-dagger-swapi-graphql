...
/**
 * Persistence exception thrown when a result was not of the expected size, for example when
 * expecting a single row but getting 0 or more than 1 rows.
 *
 * @see EmptyResultPersistenceException
 */
@SuppressWarnings("serial")
public class IncorrectResultSizePersistenceException extends DataRetrievalFailureException {
  ...
  /**
   * Constructor for IncorrectResultSizePersistenceException.
   *
   ...
   */
  public IncorrectResultSizePersistenceException(String msg, int expectedSize, Throwable ex) {
    super(msg, ex);
    this.expectedSize = expectedSize;
    this.actualSize = -1;
  }
   ...
   * @param ex the wrapped exception
   */
  public IncorrectResultSizePersistenceException(
