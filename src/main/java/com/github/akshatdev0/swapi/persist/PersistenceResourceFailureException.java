...
/**
 * Persistence exception thrown when a resource fails completely: for example, if we can't connect
 * to a database using JDBC.
 */
@SuppressWarnings("serial")
public class PersistenceResourceFailureException extends NonTransientPersistenceResourceException {
   ...
   */
  public PersistenceResourceFailureException(String msg) {
    super(msg);
  }
   ...
   */
  public PersistenceResourceFailureException(String msg, Throwable cause) {
    super(msg, cause);
  }
}
