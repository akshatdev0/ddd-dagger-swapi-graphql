...
public class DeadlockLoserPersistenceException extends PessimisticLockingFailureException {

  /**
   * Constructor for DeadlockLoserPersistenceException.
   *
   * @param msg the detail message
   * @param cause the root cause from the persistence API in use
   */
  public DeadlockLoserPersistenceException(String msg, Throwable cause) {
    super(msg, cause);
  }
}
